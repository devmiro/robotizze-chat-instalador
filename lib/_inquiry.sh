...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu RobotizzeChat que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador RobotizzeChat, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar RobotizzeChat\n"
  printf "   [1] Atualizar RobotizzeChat\n"
  printf "   [2] Deletar RobotizzeChat\n"
  printf "   [3] Bloquear RobotizzeChat\n"
  printf "   [4] Desbloquear RobotizzeChat\n"
  printf "   [5] Alter. dominio RobotizzeChat\n"
  printf "\n"
  read -p "> " option
